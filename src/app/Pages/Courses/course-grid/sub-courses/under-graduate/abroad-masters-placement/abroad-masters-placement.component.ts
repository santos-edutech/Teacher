...
@Component({
  selector: 'app-abroad-masters-placement',
  templateUrl: './abroad-masters-placement.component.html',
  styleUrls: ['./abroad-masters-placement.component.css']
})
export class AbroadMastersPlacementComponent implements OnInit {
